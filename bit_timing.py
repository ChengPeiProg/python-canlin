...
from .typechecking import BitTimingDict, BitTimingFdDict
...
class BitTiming(Mapping):
    ...
    available. The preferred way is using CAN clock frequency, prescaler, tseg1, tseg2 and sjw::
        ...
        BitTiming(f_clock=8_000_000, brp=1, tseg1=5, tseg2=1, sjw=1)
    ...
    It is also possible to specify BTR registers::
        ...
        BitTiming.from_registers(f_clock=8_000_000, btr0=0x00, btr1=0x14)

    or to calculate the timings for a given sample point::

        BitTiming.from_sample_point(f_clock=8_000_000, bitrate=1_000_000, sample_point=75.0)
    """
    ...
    def from_bitrate_and_segments(
        ...
        """Create a :class:`~BitTiming` instance from bitrate and segment lengths.
    ...
    def from_registers(
        ...
        """Create a :class:`~BitTiming` instance from registers btr0 and btr1.
    ...
    def from_sample_point(
        ...
        """Create a :class:`~BitTiming` instance for a sample point.
    ...
    def recreate_with_f_clock(self, f_clock: int) -> "BitTiming":
        """Return a new :class:`~BitTiming` instance with the given *f_clock* but the same
...
class BitTimingFd(Mapping):
    ...
    def from_bitrate_and_segments(
        ...
        """
        Create a :class:`~BitTimingFd` instance with the bitrates and segments lengths.
    ...
    def from_sample_point(
        ...
        """Create a :class:`~BitTimingFd` instance for a given nominal/data sample point pair.
    ...
    def recreate_with_f_clock(self, f_clock: int) -> "BitTimingFd":
        """Return a new :class:`~BitTimingFd` instance with the given *f_clock* but the same
