"""
The ``lin`` package provides controller area network support for
Python developers; providing common abstractions to
different hardware devices, and a suite of utilities for sending and receiving
messages on a lin bus.
"""
...
from .message import Message, LinMessage, LinMessageInfo
