...
logger = logging.getLogger("canlin.viewer")
        ...
        if self.data_structs:
            try:
                ...
                for x in self.unpack_data(
                    msg.id, self.data_structs, msg.data
                ):
